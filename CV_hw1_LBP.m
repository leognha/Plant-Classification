...
for i = 1:lengthFiles_test;
    ...
    lbp1 = extractLBPFeatures(image_test(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_test(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_test(:,:,3),'Upright',false);
    
    total_test=cat(2,lbp1,lbp2,lbp3);
...
for i = 1:lengthFiles_Blackgrass;
    ...
    lbp1 = extractLBPFeatures(image_Blackgrass(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_Blackgrass(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_Blackgrass(:,:,3),'Upright',false);
    
    total_Blackgrass=cat(2,lbp1,lbp2,lbp3);
...
for i = 1:lengthFiles_Charlock;
    ...
    lbp1 = extractLBPFeatures(image_Charlock(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_Charlock(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_Charlock(:,:,3),'Upright',false);
    
    total_Charlock=cat(2,lbp1,lbp2,lbp3);
...
for i = 1:lengthFiles_3;
    ...
    lbp1 = extractLBPFeatures(image_3(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_3(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_3(:,:,3),'Upright',false);
    
    total_3=cat(2,lbp1,lbp2,lbp3);
    data_3(i)={total_3};
end
...
for i = 1:lengthFiles_4;
    ...
    lbp1 = extractLBPFeatures(image_4(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_4(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_4(:,:,3),'Upright',false);
    
    total_4=cat(2,lbp1,lbp2,lbp3);
    data_4(i)={total_4};
...
for i = 1:lengthFiles_5;
    ...
    lbp1 = extractLBPFeatures(image_5(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_5(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_5(:,:,3),'Upright',false);
    
    total_5=cat(2,lbp1,lbp2,lbp3);
    data_5(i)={total_5};
...
for i = 1:lengthFiles_6;
    ...
    lbp1 = extractLBPFeatures(image_6(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_6(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_6(:,:,3),'Upright',false);
    
    total_6=cat(2,lbp1,lbp2,lbp3);
    data_6(i)={total_6};
...
for i = 1:lengthFiles_7;
    ...
    lbp1 = extractLBPFeatures(image_7(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_7(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_7(:,:,3),'Upright',false);
    
    total_7=cat(2,lbp1,lbp2,lbp3);
    data_7(i)={total_7};
...
for i = 1:lengthFiles_8;
    ...
    lbp1 = extractLBPFeatures(image_8(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_8(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_8(:,:,3),'Upright',false);
    
    total_8=cat(2,lbp1,lbp2,lbp3);
    data_8(i)={total_8};
...
for i = 1:lengthFiles_9;
    ...
    lbp1 = extractLBPFeatures(image_9(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_9(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_9(:,:,3),'Upright',false);
    
    total_9=cat(2,lbp1,lbp2,lbp3);
    data_9(i)={total_9};
end
...
for i = 1:lengthFiles_10;
    ...
    lbp1 = extractLBPFeatures(image_10(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_10(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_10(:,:,3),'Upright',false);
    
    total_10=cat(2,lbp1,lbp2,lbp3);
    data_10(i)={total_10};
end
...
for i = 1:lengthFiles_11;
    ...
    lbp1 = extractLBPFeatures(image_11(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_11(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_11(:,:,3),'Upright',false);
    
    total_11=cat(2,lbp1,lbp2,lbp3);
    data_11(i)={total_11};
end
...
for i = 1:lengthFiles_12;
    ...
    lbp1 = extractLBPFeatures(image_12(:,:,1),'Upright',false);
    lbp2 = extractLBPFeatures(image_12(:,:,2),'Upright',false);
    lbp3 = extractLBPFeatures(image_12(:,:,3),'Upright',false);
    
    total_12=cat(2,lbp1,lbp2,lbp3);
    data_12(i)={total_12};
end
...
% %MIN=find(min(data_result));
% %MIN=find(data_result==min(data_result(:)));
