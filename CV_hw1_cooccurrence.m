...
for i = 1:lengthFiles_test;
    ...
    co1 = graycomatrix(image_test(:,:,1));
    co2 = graycomatrix(image_test(:,:,2));
    co3 = graycomatrix(image_test(:,:,3));
    
    total_test=cat(2,co1,co2,co3);
...
for i = 1:lengthFiles_Blackgrass;
    ...
    co1 = graycomatrix(image_Blackgrass(:,:,1));
    co2 = graycomatrix(image_Blackgrass(:,:,2));
    co3 = graycomatrix(image_Blackgrass(:,:,3));
    
    total_Blackgrass=cat(2,co1,co2,co3);
...
for i = 1:lengthFiles_Charlock;
    ...
    co1 = graycomatrix(image_Charlock(:,:,1));
    co2 = graycomatrix(image_Charlock(:,:,2));
    co3 = graycomatrix(image_Charlock(:,:,3));
    
    total_Charlock=cat(2,co1,co2,co3);
...
for i = 1:lengthFiles_3;
    ...
    co1 = graycomatrix(image_3(:,:,1));
    co2 = graycomatrix(image_3(:,:,2));
    co3 = graycomatrix(image_3(:,:,3));
    
    total_3=cat(2,co1,co2,co3);
    data_3(i)={total_3};
end
...
for i = 1:lengthFiles_4;
    ...
    co1 = graycomatrix(image_4(:,:,1));
    co2 = graycomatrix(image_4(:,:,2));
    co3 = graycomatrix(image_4(:,:,3));
    
    total_4=cat(2,co1,co2,co3);
    data_4(i)={total_4};
...
for i = 1:lengthFiles_5;
    ...
    co1 = graycomatrix(image_5(:,:,1));
    co2 = graycomatrix(image_5(:,:,2));
    co3 = graycomatrix(image_5(:,:,3));
    
    total_5=cat(2,co1,co2,co3);
    data_5(i)={total_5};
...
for i = 1:lengthFiles_6;
    ...
    co1 = graycomatrix(image_6(:,:,1));
    co2 = graycomatrix(image_6(:,:,2));
    co3 = graycomatrix(image_6(:,:,3));
    
    total_6=cat(2,co1,co2,co3);
    data_6(i)={total_6};
...
for i = 1:lengthFiles_7;
    ...
    co1 = graycomatrix(image_7(:,:,1));
    co2 = graycomatrix(image_7(:,:,2));
    co3 = graycomatrix(image_7(:,:,3));
    
    total_7=cat(2,co1,co2,co3);
    data_7(i)={total_7};
...
for i = 1:lengthFiles_8;
    ...
    co1 = graycomatrix(image_8(:,:,1));
    co2 = graycomatrix(image_8(:,:,2));
    co3 = graycomatrix(image_8(:,:,3));
    
    total_8=cat(2,co1,co2,co3);
    data_8(i)={total_8};
...
for i = 1:lengthFiles_9;
    ...
    co1 = graycomatrix(image_9(:,:,1));
    co2 = graycomatrix(image_9(:,:,2));
    co3 = graycomatrix(image_9(:,:,3));
    
    total_9=cat(2,co1,co2,co3);
    data_9(i)={total_9};
end
...
for i = 1:lengthFiles_10;
    ...
    co1 = graycomatrix(image_10(:,:,1));
    co2 = graycomatrix(image_10(:,:,2));
    co3 = graycomatrix(image_10(:,:,3));
    
    total_10=cat(2,co1,co2,co3);
    data_10(i)={total_10};
end
...
for i = 1:lengthFiles_11;
    ...
    co1 = graycomatrix(image_11(:,:,1));
    co2 = graycomatrix(image_11(:,:,2));
    co3 = graycomatrix(image_11(:,:,3));
    
    total_11=cat(2,co1,co2,co3);
    data_11(i)={total_11};
end
...
for i = 1:lengthFiles_12;
    ...
    co1 = graycomatrix(image_12(:,:,1));
    co2 = graycomatrix(image_12(:,:,2));
    co3 = graycomatrix(image_12(:,:,3));
    
    total_12=cat(2,co1,co2,co3);
    data_12(i)={total_12};
end
